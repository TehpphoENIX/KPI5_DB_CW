...
public class AdminHandle extends TeacherHandle{
    ...
    public boolean createUser(String userName, AccessLevel level, String password, DBApi object) {//todo (2 AccessLevel available)
        if(object.createUser(userName,level,password) == true){
            return true;
        }
        return false;
    }
    public boolean editUser(String userName, AccessLevel level, String password, DBApi object) {//todo (2 AccessLevel available)
